    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-2">
                ...
                <div class="card-body">
                    ...
                    <div class="dashboard-progress">
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: {{$ratio*100}}%" aria-valuenow="{{$ratio*100}}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
            ...
            <div class="card mb-2">
                ...
                <div class="card-body">
                    <form action="{{route("userInfo.update", [
                        ...
                        <button type="submit" class="btn btn-warning d-none" id="submitv2">Submit (No going back)</button>
                    </div>
                    </form>
                </div>
            </div>
